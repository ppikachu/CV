...
<template>
	<div class="flex flex-col gap-4 divide-y divide-dashed divide-neutral-500">
		<article
		...
		>
			<div class="flex flex-wrap items-baseline justify-between gap-2">
				<h3 class="text-base font-bold font-heading leading-3">
					{{ article.title }}
					<span v-if="article.category" class="font-semibold text-xs ml-1.5">
						({{ article.category }})
					</span>
				</h3>
